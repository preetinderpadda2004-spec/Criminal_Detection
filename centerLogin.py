...
class Main:
    def __init__(self):
        ...
        self.title = tkinter.Label(self.root, text="Center Login", font=("Arial", "20", "bold"),bg=self.secondaycolor,fg=self.txtcolor,width=10)
        ...
        self.txt2 = tkinter.Entry(self.formFrame, font=self.formFont,relief="raised",show="*")
    ...
    def adminLogin(self):
        ...
        if len(res)==0:
            ...
            self.root.destroy()
            centerDashboard.Main(centerDetails=res)
